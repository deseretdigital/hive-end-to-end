...
export default async function run() {
  ...
  await start(null, "utah")
    ...
    .expectKey("page_data.containers.1.data.contentprofiles.0")
    ...
    .expectKey("page_data.containers.6.data.contentprofiles.0")
    .expectKey("page_data.containers.6.data.contentprofiles.1")
    .expectKey("page_data.containers.6.data.contentprofiles.2")
    .expectKey("page_data.containers.6.data.contentprofiles.3")
